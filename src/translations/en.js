const en = {
  ...
  now: {
    hint: "building with AI",
    p1: "Currently leading and idealizing AI-first products — agentic workflows and LLM-powered tools on top of solid APIs.",
    p2: "First one shipped: a speaker–audience platform, solo-built — 2nd place at the SuperViz Hackathon 2.0.",
  },
  ...
  term: {
    ...
    cmd: {
      ...
      catEdu: "use `edu`.",
      catNotFound: "cat: {file}: no such file or directory",
      ...
      fortune: [
        ...
        "naming things: still harder than distributed systems.",
        "a friday deploy is a monday story.",
      ...
      colorSet: "phosphor set to {color}.",
      ...
      hack: [
        "initializing exploit framework… [ok]",
        "scanning 256 ports on {host}… [3 open]",
        "bypassing firewall… [ok]",
        "brute-forcing credentials… ▓▓▓▓▓▓▓▓▓▓ 100%",
        "ACCESS GRANTED.",
        "just kidding — I only touch approved staging environments. ;)",
      ],
      hackDefaultHost: "the mainframe",
      ping: [
        "PING {host} 56 data bytes",
        "64 bytes from {host}: icmp_seq=1 time=1.21 ms",
        "64 bytes from {host}: icmp_seq=2 time=0.98 ms",
